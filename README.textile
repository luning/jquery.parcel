...
p({background:LightBlue}. Common logic

p({background:LightBlue}. With normal jQuery field

p({background:LightBlue}. With array field

p(. With Parcel as field

p(. With virtual field

p(. With behaviour

p(. With initial state

p(. Build multiple Parcels at once

<h3><a name="api_parcel_op">Parcel Operations</a></h3>

p(. sync(context)        Returns: Parcel

p(. captureState()        Returns: Parcel

p(. orderFields(fieldName1, fieldName2, [...])        Returns: Parcel

p(. renameFields(setting)        Returns: Parcel

p(. addBahaviour(behaviour)        Returns: Parcel
...
p(. state()        Returns: object/string/array

p(. state(s)        Returns: Field

p(. defaultState()        Returns: object/string/array

p(. defaultState(s)        Returns: Field

p(. resetState()        Returns: Field

p(. initialState()        Returns: object

p(. isDirty()        Returns: boolean

p(. revertState()        Returns: Field

p(. closestParcel()        Returns: Parcel

p(. getParcel()        Returns: Parcel

p(. sync()        Returns: array of added fields

p(. removeMe()        Returns: Field

p(. parcelIgnored()        Returns: boolean

p(. fieldDom()        Returns: array of DOM elements

<h3><a name="api_field_event">Field Events</a></h3>

p(. bindState(context, converter)        Returns: Field

p(. change(handler)        Returns: Field

p(. stateChange(handler)        Returns: Field

p(. showHide(target, showUpState/showUpCallback, [resetTarget], [callback])        Returns: Field
...
p(. $.stateEqual(s1, s2)        Returns: boolean

p(. $.stateContain(whole, partial)        Returns: boolean

p(. $.stateEmpty()        Returns: boolean

p(. $.cloneState(s)        Returns: object/string/array
