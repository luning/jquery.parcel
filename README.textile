...
** "Building Composite Parcels":#more_compositeParcel
** "Add/Remove DOM elements Dynamically":#more_sync
** "Virtual Field":#more_virtual
# "API Reference":#api
** "Parcel":#api_parcel
*** "Building a Parcel":#api_parcel_build
...
<h2><a name="more_compositeParcel">Building Composite Parcels</a></h2>
...
<h3><a name="api_parcel_build">Building a Parcel</a></h3>
...
<h2><a name="api_sync">Parcel Dom Sync</a></h2>
